            ...
            <section className="pt-12 border-t border-slate-800 space-y-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Ý kiến từ khách hàng đã mua và trải nghiệm thực tế</p>
                </div>
                <div className="px-4 py-2 bg-slate-900 border border-slate-800 rounded-2xl flex items-center gap-2 text-sm">
                  <Star className="w-4 h-4 fill-amber-400 text-amber-400" />
                  <span className="font-bold text-white">{product.averageRating}</span>
